...
class TcpConnection final : public eko::core::IByteTransport {
 public:
...
class TcpListener {
 public:
  ...
  eko::core::Status bind_and_listen(std::string bind_ip, std::uint16_t port, int backlog = 4) noexcept;
  eko::core::Result<TcpConnection> accept_one() noexcept;
