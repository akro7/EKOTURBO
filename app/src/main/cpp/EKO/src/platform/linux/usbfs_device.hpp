...
class UsbFsDevice {
 public:
  ...
  eko::core::Status open_and_init() noexcept;
 ...
 private:
  eko::core::Status parse_descriptors_() noexcept;
  void query_caps_() noexcept;

  bool kernel_driver_active_() const noexcept;
  eko::core::Status detach_kernel_driver_() noexcept;
  void attach_kernel_driver_() noexcept;
  eko::core::Status claim_interface_() noexcept;
