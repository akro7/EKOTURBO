...
class ByteSource {
 public:
  ...
  virtual eko::core::Status status() const noexcept { return {}; }
};
...
// ─── FD-based source (للملفات المفتوحة من Java/Android بدون path حقيقي) ───
// يستخدم fstat() لمعرفة الحجم ثم pread() للقراءة — لا يعتمد على /proc/self/fd/N
